                    ...
                    <div class="card-text">
                        <form action="#" method="POST">
                            ...
                            <div class="d-flex justify-content-between">
                                <button type="submit" name="register_btn" class="btn btn-sm btn-outline-dark">Create
                                    Account <i class="bi bi-person-plus"></i></button>
                                <a href="login.php"
                                    class="link-secondary link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover">Login<i
