    ...
    <div class="row">
        <div class="col-8 d-flex flex-column align-items-center justify-content-center p-5 border border-black">
            ...
            <ul class="list-unstyled mt-4">
                <li><i class="bi bi-buildings-fill"></i> Wide Selection of Listings</li>
                <li><i class="bi bi-binoculars-fill"></i> Smart Search Tools</li>
                <li><i class="bi bi-camera-fill"></i> High-Quality Visual Tours</li>
                <li><i class="bi bi-chat-dots-fill"></i> Seamless Communication</li>
            </ul>
        </div>
        <div class="col-3">
